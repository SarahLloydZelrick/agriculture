...
if($_GET["type"] == "view"){
    header("Location: for-cassava-plant-pest.php?date=".$_GET['date']."&location=".$_GET['location']."&name=".$_GET['name']."");
	exit;
}
?>
<!DOCTYPE html>
        ...
        if (isset($_POST['btnsave'] )) {
            ...
            ('".$reporttype."','".$date."','".$location."','".$name."','".$cornborer1."','".$cornborer2."','".$cornborer3."','".$cornborer4."','".$cornborer5."','".$cornborer6."','".$cornborer7."','".$cornborer8."','".$cornborer9."','".$cornborer10."','".$cornborer11."','".$cornborer12."',,'".$cornborer13."','".$cornborer14."','".$cornborer15."','".$cornborer16."','".$cornborer17."','".$cornborer18."','".$cornborer19."','".$cornborer20."','".$cornborer21."','".$reportid."','".$crop."','".$variety."','".$gps."','".$growthstage."','".$area."')";
                if(mysqli_query($con, $sql)){
                    ...
                    $sql2 = "INSERT INTO `tbl_cassava_pest_2`(`id`, `reportid`, `earworm1`, `earworm2`, `earworm3`, `earworm4`, `earworm5`, `earworm6`, `earworm7`, `earworm8`, `earworm9`, `earworm10`, `earworm11`, `earworm12`, `earworm13`, `earworm14`, `earworm15`, `earworm16`, `earworm17`, `earworm18`, `earworm19`, `earworm20`, `earworm21`) VALUES
                        ...
                        if(mysqli_query($con, $sql2)){
                            ...
                            ('".$reportid."','".$planthopper1."','".$planthopper2."','".$planthopper3."','".$planthopper4."','".$planthopper5."','".$planthopper6."','".$planthopper7."','".$planthopper8."','".$planthopper9."','".$planthopper10."','".$planthopper11."','".$planthopper12."','".$planthopper13."','".$planthopper14."','".$planthopper15."','".$planthopper16."',,'".$planthopper17."','".$planthopper18."','".$planthopper19."','".$planthopper20."','".$planthopper21."')";
                                if(mysqli_query($con, $sql3)){
                                    ...
                                    $sql4 = "INSERT INTO `tbl_cassava_pest_4`(`reportid`, `armyworm1`, `armyworm2`, `armyworm3`, `armyworm4`, `armyworm5`, `armyworm6`, `armyworm7`, `armyworm8`, `armyworm9`, `armyworm10`, `armyworm11`, `armyworm12`, `armyworm13`, `armyworm14`, `armyworm15`, `armyworm16`, `armyworm17`, `armyworm18`, `armyworm19`, `armyworm20`, `armyworm21`)  VALUES
                                    ('".$reportid."','".$armyworm1."','".$armyworm2."','".$armyworm3."','".$armyworm4."','".$armyworm5."','".$armyworm6."','".$armyworm7."','".$armyworm8."','".$armyworm9."','".$armyworm10."','".$armyworm11."','".$armyworm12."','".$armyworm13."','".$armyworm14."','".$armyworm15."','".$armyworm16."',,'".$armyworm17."','".$armyworm18."','".$armyworm19."','".$armyworm20."','".$armyworm21."')";
                                        if(mysqli_query($con, $sql4)){
                                            ...
                                            $sql5 = "INSERT INTO `tbl_cassava_pest_5`(`reportid`, `fallarmyworm1`, `fallarmyworm2`, `fallarmyworm3`, `fallarmyworm4`, `fallarmyworm5`, `fallarmyworm6`, `fallarmyworm7`, `fallarmyworm8`, `fallarmyworm9`, `fallarmyworm10`, `fallarmyworm11`, `fallarmyworm12`, `fallarmyworm13`, `fallarmyworm14`, `fallarmyworm15`, `fallarmyworm16`, `fallarmyworm17`, `fallarmyworm18`, `fallarmyworm19`, `fallarmyworm20`, `fallarmyworm21`) VALUES
                                            ('".$reportid."','".$fallarmyworm1."','".$fallarmyworm2."','".$fallarmyworm3."','".$fallarmyworm4."','".$fallarmyworm5."','".$fallarmyworm6."','".$fallarmyworm7."','".$fallarmyworm8."','".$fallarmyworm9."','".$fallarmyworm10."','".$fallarmyworm11."','".$fallarmyworm12."','".$fallarmyworm13."','".$fallarmyworm14."','".$fallarmyworm15."','".$fallarmyworm16."',,'".$fallarmyworm17."','".$fallarmyworm18."','".$fallarmyworm19."','".$fallarmyworm20."','".$fallarmyworm21."')";
                                                if(mysqli_query($con, $sql5)){
                                                    ...
                                                    $sql6 = "INSERT INTO `tbl_cassava_pest_6`(`reportid`, `blanded1`, `blanded2`, `blanded3`, `blanded4`, `blanded5`, `blanded6`, `blanded7`, `blanded8`, `blanded9`, `blanded10`, `blanded11`, `blanded12`, `blanded13`, `blanded14`, `blanded15`, `blanded16`, `blanded17`, `blanded18`, `blanded19`, `blanded20`, `blanded21`) VALUES
                                                    ('".$reportid."','".$blanded1."','".$blanded2."','".$blanded3."','".$blanded4."','".$blanded5."','".$blanded6."','".$blanded7."','".$blanded8."','".$blanded9."','".$blanded10."','".$blanded11."','".$blanded12."','".$blanded13."','".$blanded14."','".$blanded15."','".$blanded16."',,'".$blanded17."','".$blanded18."','".$blanded19."','".$blanded20."','".$blanded21."')";
                                                        if(mysqli_query($con, $sql6)){
                                                            ...
                                                            $sql7 = "INSERT INTO `tbl_cassava_pest_7`(`reportid`, `bacteria1`, `bacteria2`, `bacteria3`, `bacteria4`, `bacteria5`, `bacteria6`, `bacteria7`, `bacteria8`, `bacteria9`, `bacteria10`, `bacteria11`, `bacteria12`, `bacteria13`, `bacteria14`, `bacteria15`, `bacteria16`, `bacteria17`, `bacteria18`, `bacteria19`, `bacteria20`, `bacteria21`) VALUES
                                                            ('".$reportid."','".$bacteria1."','".$bacteria2."','".$bacteria3."','".$bacteria4."','".$bacteria5."','".$bacteria6."','".$bacteria7."','".$bacteria8."','".$bacteria9."','".$bacteria10."','".$bacteria11."','".$bacteria12."','".$bacteria13."','".$bacteria14."','".$bacteria15."','".$bacteria16."',,'".$bacteria17."','".$bacteria18."','".$bacteria19."','".$bacteria20."','".$bacteria21."')";
                                                                if(mysqli_query($con, $sql7)){
                                                                    ...
                                                                    $sql8 = "INSERT INTO `tbl_cassava_pest_8`(`reportid`, `downy1`, `downy2`, `downy3`, `downy4`, `downy5`, `downy6`, `downy7`, `downy8`, `downy9`, `downy10`, `downy11`, `downy12`, `downy13`, `downy14`, `downy15`, `downy16`, `downy17`, `downy18`, `downy19`, `downy20`, `downy21`) VALUES
                                                                    ('".$reportid."','".$downy1."','".$downy2."','".$downy3."','".$downy4."','".$downy5."','".$downy6."','".$downy7."','".$downy8."','".$downy9."','".$downy10."','".$downy11."','".$downy12."','".$downy13."','".$downy14."','".$downy15."','".$downy16."',,'".$downy17."','".$downy18."','".$downy19."','".$downy20."','".$downy21."')";
                                                                        if(mysqli_query($con, $sql8)){
                                                                            ...
                                                                            $sql9 = "INSERT INTO `tbl_cassava_pest_9`(`reportid`, `kindoffertilizer`, `amountapplied`, `dateapplied`, `kindofpesticide`, `dosage`, `dateappliedplanting`, `tankloads`, `preparedbyname`, `designation`, `dateremarks`) VALUES
