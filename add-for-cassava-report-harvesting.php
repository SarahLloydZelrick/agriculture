...
if($_GET["type"] == "view"){
    header("Location: for-cassava-report-harvesting.php?dateto=".$_GET['dateto']."&datefrom=".$_GET['datefrom']."");
	exit;
}
?>
<!DOCTYPE html>
