<div class="w-60 shadow-md bg-white absolute" id="sidenav" style="z-index:5">
  <div class="pt-4 pb-2 px-6">
    <a href="#!">
    <div class="flex flex-col items-center">
        <div class="grow ml-3">
        <img src="images/icons/logo_doa.png" class="w-24" alt="Agriculture">
        </div>
      </div>
      <div class="flex flex-col items-center">
        <div class="grow ml-3">
  ...
  <!--div class="text-center bottom-0 absolute w-full">
    <hr class="m-0">
    <a href="logout.php">
        <p class="py-2 text-sm text-white">LOGOUT</p>
    </a>
  </div-->
</div>
