...
<span
  ...
  <ul class="relative px-1">
    ...
    <li class="relative admin superuser" id="sidenavSecEx2">
      ...
      <ul class="relative accordion-collapse collapse" id="collapseSidenavSecEx2" aria-labelledby="sidenavSecEx2" data-bs-parent="#sidenavSecExample" style="visibility:visible !important;">
        <li class="relative">
    ...
    <li class="relative admin staff superuser" id="sidenavSecEx3">
      ...
      <ul class="relative accordion-collapse collapse" id="collapseSidenavSecEx3" aria-labelledby="sidenavSecEx3" data-bs-parent="#sidenavSecExample" style="visibility:visible !important;">
        <li class="relative super-hide">
        ...
        <li class="relative">
          <a href="select-rsbsa.php" class="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-white text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">View RSBSA</a>
        </li>
      </ul>
    </li>
  ...
  <ul class="relative px-1">
    ...
    <li class="relative admin staff superuser" id="sidenavSecEx4">
      ...
      <ul class="relative accordion-collapse collapse" id="collapseSidenavSecEx4" aria-labelledby="sidenavSecEx4" data-bs-parent="#sidenavSecExample" style="visibility:visible !important;">
        <li class="relative super-hide">
          <a href="corn-report.php" class="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-white text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">
            Corn Report
          </a>
        </li>
        <li class="relative">
          <a href="cassava-report.php" class="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-white text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">
            Cassava Report</a>
        </li>
        <li class="relative">
          <a href="rice-report.php" class="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-white text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">
            Rice Report</a>
        </li>
        <li class="relative">
          <a href="highvalue-report.php" class="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-white text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">
            High Value Crops Report</a>
        </li>
        <li class="relative">
          <a href="other-report.php" class="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-white text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="primary">
            Other Report</a>
        </li>
      </ul>
    </li>
    ...
    <li class="relative admin superuser">
      <a class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-white text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" href="audittrail.php" data-mdb-ripple="true" data-mdb-ripple-color="primary">
    ...
    <li class="relative farmer" style="display:none;">
      <a class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-white text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" href="farmer-rsbsa.php" data-mdb-ripple="true" data-mdb-ripple-color="primary">
        <span>MY RSBSA</span>
      </a>
    </li>
