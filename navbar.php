...
<span
  ...
  <ul class="relative px-1">
    ...
    <li class="relative admin staff superuser" id="sidenavSecEx3">
      ...
      <ul class="relative accordion-collapse collapse" id="collapseSidenavSecEx3" aria-labelledby="sidenavSecEx3" data-bs-parent="#sidenavSecExample" style="display:block !important;">
        <li class="relative super-hide">
