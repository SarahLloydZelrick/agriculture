...
<body>
    <?php
        ...
        include "topbar.php";
    ?>
    <div class="rsbsa_container ml-60 pt-10">
                    ...
                    <div class="personal_info flex flex-col gap-1">
                        ...
                        <div class="flex flex-row w-full">
                            ...
                            <div class="flex flex-col gap-2 w-full p-2">
                                ...
                                <input type="text" class="form-input w-full" name="barangay" placeholder="Barangay">
                            </div>
                        </div>
                        <div class="flex flex-row w-full">
                            <div class="flex flex-col gap-2 w-full p-2">
