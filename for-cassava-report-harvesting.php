        ...
        if (isset($_POST['btnupdate'] )) {
           ...
           /* for($i = 1; $i<=25; $i++) {
            ...
            $sql1 = "UPDATE `tbl_cassava_harvestng_report` SET `nooffarmers`='".$nooffarmer1."',`hybridyellowarea`='".$hybridyellow1a."',`hybridyellowyield`='".$hybridyellow1b."',`hybridyellowprod`'".$hybridyellow1c."',`hybridwhitearea`'".$hybridwhite1a."',`hybridwhiteyield`'".$hybridwhite1b."',`hybridwhiteprod`='".$hybridwhite1c."',`hybridcombinearea`='".$hybridcombine1a."',`hybridcombineyield`='".$hybridcombine1b."',`hybridcombineprod`='".$hybridcombine1c."',`opvyellowarea`='".$opvyellow1a."',`opvyellowyield`='".$opvyellow1b."',`opvyellowprod`='".$opvyellow1c."',`opvwhitearea`='".$opvwhite1a."',`opvwhiteyield`='".$opvwhite1b."',`opvwhiteprod`='".$opvwhite1c."',`opvcombinearea`='".$opvcombine1a."',`opvcombineyield`='".$opvcombine1b."',`opvcombineprod`='".$opvcombine1c."',`grandyellowarea`='".$grandyellow1a."',`grandyellowyield`='".$grandyellow1b."',`grandyellowprod`='".$grandyellow1c."',`grandwhitearea`='".$grandwhite1a."',`grandwhiteyield`='".$grandwhite1b."',`grandwhiteprod`='".$grandwhite1c."',`grandcombinearea`='".$grandtotal1a."',`grandcombineyield`='".$grandtotal1b."',`grandcombineprod`='".$grandtotal1c."' WHERE `id` = '".$reportid1."'";
                ...
                $sql4 = "UPDATE `tbl_cassava_harvestng_report` SET `nooffarmers`='".$nooffarmer4."',`hybridyellowarea`='".$hybridyellow4a."',`hybridyellowyield`='".$hybridyellow4b."',`hybridyellowprod`'".$hybridyellow4c."',`hybridwhitearea`'".$hybridwhite4a."',`hybridwhiteyield`'".$hybridwhite4b."',`hybridwhiteprod`='".$hybridwhite4c."',`hybridcombinearea`='".$hybridcombine4a."',`hybridcombineyield`='".$hybridcombine4b."',`hybridcombineprod`='".$hybridcombine4c."',`opvyellowarea`='".$opvyellow4a."',`opvyellowyield`='".$opvyellow4b."',`opvyellowprod`='".$opvyellow4c."',`opvwhitearea`='".$opvwhite4a."',`opvwhiteyield`='".$opvwhite4b."',`opvwhiteprod`='".$opvwhite4c."',`opvcombinearea`='".$opvcombine4a."',`opvcombineyield`='".$opvcombine4b."',`opvcombineprod`='".$opvcombine4c."',`grandyellowarea`='".$grandyellow4a."',`grandyellowyield`='".$grandyellow4b."',`grandyellowprod`='".$grandyellow4c."',`grandwhitearea`='".$grandwhite4a."',`grandwhiteyield`='".$grandwhite4b."',`grandwhiteprod`='".$grandwhite4c."',`grandcombinearea`='".$grandtotal4a."',`grandcombineyield`='".$grandtotal4b."',`grandcombineprod`='".$grandtotal4c."' WHERE `id` = '".$reportid4."'";
                ...
                $sql5 = "UPDATE `tbl_cassava_harvestng_report` SET `nooffarmers`='".$nooffarmer5."',`hybridyellowarea`='".$hybridyellow5a."',`hybridyellowyield`='".$hybridyellow5b."',`hybridyellowprod`'".$hybridyellow5c."',`hybridwhitearea`'".$hybridwhite5a."',`hybridwhiteyield`'".$hybridwhite5b."',`hybridwhiteprod`='".$hybridwhite5c."',`hybridcombinearea`='".$hybridcombine5a."',`hybridcombineyield`='".$hybridcombine5b."',`hybridcombineprod`='".$hybridcombine5c."',`opvyellowarea`='".$opvyellow5a."',`opvyellowyield`='".$opvyellow5b."',`opvyellowprod`='".$opvyellow5c."',`opvwhitearea`='".$opvwhite5a."',`opvwhiteyield`='".$opvwhite5b."',`opvwhiteprod`='".$opvwhite5c."',`opvcombinearea`='".$opvcombine5a."',`opvcombineyield`='".$opvcombine5b."',`opvcombineprod`='".$opvcombine5c."',`grandyellowarea`='".$grandyellow5a."',`grandyellowyield`='".$grandyellow5b."',`grandyellowprod`='".$grandyellow5c."',`grandwhitearea`='".$grandwhite5a."',`grandwhiteyield`='".$grandwhite5b."',`grandwhiteprod`='".$grandwhite5c."',`grandcombinearea`='".$grandtotal5a."',`grandcombineyield`='".$grandtotal5b."',`grandcombineprod`='".$grandtotal5c."' WHERE `id` = '".$reportid5."'";
        ...
        <div class="flex flex-col gap-2">
            <form method="POST" action="" class="flex flex-col gap-2" style="overflow-x:auto">
                <table style="width:100%">
                    ...
                    <!-- 1 -->
                    <?php
                    $sql = "SELECT * FROM `tbl_cassava_harvestng_report` WHERE fromdate = '$fromdate' AND todate = '$todate'";
                    ...
                    <tr>
                        ...
                        <!-- HYBRID YELLOW -->
                        <td>
                            <input type="number" class="form-input" name="hybridyellow<?php echo $i;?>a" id="" value="<?php echo $row['hybridyellowarea']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="hybridyellow<?php echo $i;?>b" id="" value="<?php echo $row['hybridyellowyield']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="hybridyellow<?php echo $i;?>c" id="" value="<?php echo $row['hybridyellowprod']?>" disabled="true">
                        </td>
                        <!-- HYBRID WHITE -->
                        <td>
                            <input type="number" class="form-input" name="hybridwhite<?php echo $i;?>a" id="" value="<?php echo $row['hybridwhitearea']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="hybridwhite<?php echo $i;?>b" id="" value="<?php echo $row['hybridwhiteyield']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="hybridwhite<?php echo $i;?>c" id="" value="<?php echo $row['hybridwhiteprod']?>" disabled="true">
                        </td>
                        <!-- HYBRID COMBINE -->
                        <td>
                            <input type="number" class="form-input" name="hybridcombine<?php echo $i;?>a" id="" value="<?php echo $row['hybridcombinearea']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="hybridcombine<?php echo $i;?>b" id="" value="<?php echo $row['hybridcombineyield']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="hybridcombine<?php echo $i;?>c" id="" value="<?php echo $row['hybridcombineprod']?>" disabled="true">
                        </td>
                        <!-- OPV YELLOW -->
                        <td>
                            <input type="number" class="form-input" name="opvyellow<?php echo $i;?>a" id="" value="<?php echo $row['opvyellowarea']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="opvyellow<?php echo $i;?>b" id="" value="<?php echo $row['opvyellowyield']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="opvyellow<?php echo $i;?>c" id="" value="<?php echo $row['opvyellowprod']?>" disabled="true">
                        </td>
                        <!-- OPV WHITE -->
                        <td>
                            <input type="number" class="form-input" name="opvwhite<?php echo $i;?>a" id="" value="<?php echo $row['opvwhitearea']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="opvwhite<?php echo $i;?>b" id="" value="<?php echo $row['opvwhiteyield']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="opvwhite<?php echo $i;?>c" id="" value="<?php echo $row['opvwhiteprod']?>" disabled="true">
                        </td>
                        <!-- OPV COMBINE -->
                        <td>
                            <input type="number" class="form-input" name="opvcombine<?php echo $i;?>a" id="" value="<?php echo $row['opvcombinearea']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="opvcombine<?php echo $i;?>b" id="" value="<?php echo $row['opvcombineyield']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="opvcombine<?php echo $i;?>b" id="" value="<?php echo $row['opvcombineprod']?>" disabled="true">
                        </td>
                        <!-- GRAND TOTAL YELLOW -->
                        <td>
                            <input type="number" class="form-input" name="grandyellow<?php echo $i;?>a" id="" value="<?php echo $row['grandyellowarea']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="grandyellow<?php echo $i;?>b" id="" value="<?php echo $row['grandyellowyield']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="grandyellow<?php echo $i;?>c" id="" value="<?php echo $row['grandyellowprod']?>" disabled="true">
                        </td>
                        <!-- GRAND TOTAL WHITE -->
                        <td>
                            <input type="number" class="form-input" name="grandwhite<?php echo $i;?>a" id="" value="<?php echo $row['grandwhitearea']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="grandwhite<?php echo $i;?>b" id="" value="<?php echo $row['grandwhiteyield']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="grandwhite<?php echo $i;?>c" id="" value="<?php echo $row['grandwhiteprod']?>" disabled="true">
                        </td>
                        <!-- GRAND TOTAL TOTAL -->
                        <td>
                            <input type="number" class="form-input" name="grandtotal<?php echo $i;?>a" id="" value="<?php echo $row['grandcombinearea']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="grandtotal<?php echo $i;?>b" id="" value="<?php echo $row['grandcombineyield']?>" disabled="true">
                        </td>
                        <td>
                            <input type="number" class="form-input" name="grandtotal<?php echo $i;?>c" id="" value="<?php echo $row['grandcombineprod']?>" disabled="true">
                        </td>
                    <?php
