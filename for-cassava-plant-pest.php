...
<head>
    ...
    <title>View Cassava Plant Pest</title>
...
<body>
    ...
    <div class="container flex flex-col p-10 ml-0 w-fit md:ml-60 " >
        <div class="flex flex-row justify-between">
            <h2 class="text-2xl font-bold"> CASSAVA PLANT PEST MONITORING FORM </h2>
        ...
        <div class="flex flex-col gap-2">
            <form method="POST" action="" class="flex flex-col gap-2" style="overflow-x:auto">
                <table class="w-fit">
                    <tr>
                        <th colspan="22" style="text-align:center !important;"> CASSAVA PLANT PEST MONITORING FORM </th>
                    </tr>
                    <?php
                    $sql = "SELECT * FROM `tbl_cassava_pest_1` WHERE reportid = '$reportid'";
                ...
                ?>
                <?php
                    $sql = "SELECT * FROM `tbl_cassava_pest_2` WHERE reportid = '$reportid'";
                    $result = mysqli_query($con, $sql);
                ...
                ?>
                <?php
                    $sql = "SELECT * FROM `tbl_cassava_pest_3` WHERE reportid = '$reportid'";
                    $result = mysqli_query($con, $sql);
                ...
                ?>
                <?php
                    $sql = "SELECT * FROM `tbl_cassava_pest_4` WHERE reportid = '$reportid'";
                    $result = mysqli_query($con, $sql);
                ...
                ?>
                <?php
                    $sql = "SELECT * FROM `tbl_cassava_pest_5` WHERE reportid = '$reportid'";
                    $result = mysqli_query($con, $sql);
                ...
                ?>
                    ...
                    <?php
                    $sql = "SELECT * FROM `tbl_cassava_pest_6` WHERE reportid = '$reportid'";
                    $result = mysqli_query($con, $sql);
                    ...
                    ?>
                    <?php
                    $sql = "SELECT * FROM `tbl_cassava_pest_7` WHERE reportid = '$reportid'";
                    $result = mysqli_query($con, $sql);
                    ...
                    ?>
                    <?php
                    $sql = "SELECT * FROM `tbl_cassava_pest_8` WHERE reportid = '$reportid'";
                    $result = mysqli_query($con, $sql);
                    ...
                    <?php
                    $sql = "SELECT * FROM `tbl_cassava_pest_9` WHERE reportid = '$reportid'";
                    $result = mysqli_query($con, $sql);
