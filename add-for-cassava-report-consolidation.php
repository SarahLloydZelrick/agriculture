...
if($_GET["type"] == "view"){
    header("Location: for-cassava-report-consolidation.php?dateto=".$_GET['dateto']."&datefrom=".$_GET['datefrom']."");
	exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Add Cassava Report Consolidation</title>
...
<body>
    <?php
        ...
        $reporttype = "CassavaConsolidation";
        $todate = $_GET['dateto'];
        ...
        if (isset($_POST['btnsave'] )) {
            ...
            if($nooffarmer1 != "")
                {
                $sql = "INSERT INTO `tbl_cassava_consolidation_report`(`barangay`, `reportype`, `variety`, `nooffarmers`, `areaplanted`, `areaharvested`, `production`, `stagesofcrop`, `fromdate`, `todate`) VALUES 
